...
# File logger
def setup_logging(log_dir, loglevel):
    ...
    console_handler.setLevel(logging.DEBUG) # all message can print to console
...
def process_config(json_file, loglevel):
    """
    Get the json file
    ...
    setup_logging(config.log_dir, loglevel)
